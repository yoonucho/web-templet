		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">아이디</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">이름</a></th>
...
<c:if test="${paginationInfo.list !=null }">
	<c:forEach var="map" items="${paginationInfo.list}" varStatus="status">
				<tr <c:if test="${(status.count mod 2)==0 }">class="alternate-row"</c:if>>
					...
					<td>${map.usr_id }</td>
					<td>
						<a href="${pageContext.request.contextPath}/us/ma/USMA030Q.do?usr_id=${map.usr_id }">${map.name }</a>
					</td>
					<td>${map.reg_nm }</td>
					<td>${map.reg_dt }</td>
					<td>${map.brd_hit }</td>
...
<!-- 				</tr> -->
	...
	<div class="clear">&nbsp;</div>
<a href="${pageContext.request.contextPath}/us/ma/USMA020Q.do" >등록</a>
<a href="${pageContext.request.contextPath}/us/ma/USMA020Q.do" >삭제</a>
