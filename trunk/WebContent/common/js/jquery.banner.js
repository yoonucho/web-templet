$(function() {
    ...
    $.fn.jQBanner = function(defaults){
        ...
        config.objBtn = "#"+this.attr("id")+" .paging02";
    ...
    function jsBanInit(config) {
        ...
        if (config.isActType == "left") {
            $(config.objScr+" .sub_main").each(function(i){
    ...
    function jsScrPauseBind(config) {
        ...
        $(config.objScr).click(function(){
        	if(config.isStop == 'Y') {
        		config.isActType = "fade";
        		config.isStop = 'N';
        		clearTimeout(config.objTimer);
        	} else {
        		config.isActType = "none";
        		config.isStop = 'Y';
        	}
        });
    }
    ...
    function jsBanBtnRO (config,nSel) {
        if (config.isBtnType=="img") {
            $(config.objBtn+" img").each(function(i){
                if (nSel==i) {
                	$('#flash_area_'+i).attr('innerHTML',$('#flash_area_'+i).attr('innerHTML'));
