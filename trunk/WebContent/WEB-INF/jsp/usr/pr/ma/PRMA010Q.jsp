...
<c:if test="${paginationInfo.list !=null }">
	<c:forEach var="map" items="${paginationInfo.list}" varStatus="status">
				<tr>
					...
					<td><a href="./PRMA030Q.do?prd_seq_no=${map.prd_seq_no }">${map.prd_nm }</a></td>
					<td>
						<a href="./PRMA030Q.do?prd_seq_no=${map.prd_seq_no }">${map.prd_price }</a>
					</td>
					<td>
						<a href="./PRMA030Q.do?prd_seq_no=${map.prd_seq_no }">${map.cate_nm }</a>
					</td>
					<td>${map.reg_nm }</td>
					<td>${map.reg_dt }</td>
					<td>${map.brd_hit }</td>
