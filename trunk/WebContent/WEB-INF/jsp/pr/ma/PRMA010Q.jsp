		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">상품명</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">가격</a></th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">카테고리</a></th>
...
<a href="${pageContext.request.contextPath}/pr/ma/PRMA020Q.do" >삭제</a>
