...
<body>
	...
	<div id="box">
		<h3 id="adduser">답글등록</h3>
		<form action="${pageContext.request.contextPath}/bd/ma/BDMA080T.do" name="frmSave" id="frmSave" method="post" enctype="multipart/form-data" class="form">
			<input type="hidden" name="brd_seq_no_p" value="${param.brd_seq_no }" />
