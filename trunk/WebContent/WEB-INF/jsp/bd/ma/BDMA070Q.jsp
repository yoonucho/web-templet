...
<tr>
	...
	<tr>
		<th valign="top">내용</th>
		<td><textarea name="content" rows="" cols="" class="form-textarea" readonly="readonly">${map.content }</textarea></td>
		<td></td>
	</tr>
<c:if test="${filList !=null }">
	<c:forEach var="map" items="${filList}" varStatus="status">
										<tr>
											<th>FILE ${status.count }:</th>
											<td>
...
<a href="${pageContext.request.contextPath}/bd/ma/BDMA040Q.do?brd_seq_no=${map.brd_seq_no}">수정</a>
<div class="clear"></div>
