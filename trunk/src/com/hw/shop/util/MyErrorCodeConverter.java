...
public class MyErrorCodeConverter implements ErrorCodeConverter {
	...
	@Override
	public String convertPropertyErrorCode(String errorCode, Class clazz,
			String property) {
		log.error(String.format("Property %s %s %s", errorCode, clazz
	...
	public String convertGlobalErrorCode(String errorCode, Class clazz) {
		log.error(String.format("Global %s %s", errorCode, clazz.getClass()
				.getName()));
		return errorCode;
	}
}
